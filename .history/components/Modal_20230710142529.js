    ...
    <dialog className={styles.dialogContainer} open={modalState}>
      ...
      <div className={styles.innerContainer}>
        ...
        <p className={styles.description}>
          ...
          this website I chose to go the minimalistic route, to focus the
          attention to on the works. Working with the client we decided on what
          was the most important content and decided to display that front and
          center. <br /> <br />
