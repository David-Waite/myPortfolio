  ...
  return (
    <div className={styles.outerContainer}>
      <div className={styles.container}>
        {/* <img
          className={`${styles.img} ${styles.imgOnScreen}`}
          src={images[imageIndexs.imageOne]}
        />
        <img
          className={`${styles.img} ${styles.imgComingToScreen}`}
          src={images[imageIndexs.imageTwo]}
        /> */}
        <img
          className={`${styles.img} ${styles.imgOffScreen}`}
          src={images[imageIndexs.imageThree]}
        />
      </div>
    </div>
  );
