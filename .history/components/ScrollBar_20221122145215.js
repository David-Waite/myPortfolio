...
export default function ScrollBar() {
  ...
  } else if (scrollPosition > height / 2 - 117) {
    const change = ((scrollPosition - (height / 2 - 117)) / 280) * 100;
    console.log(change);
    style = {
      background: "rgb(58,184,255)",
      background: `linear-gradient(330deg,  rgba(44,44,44,1) ${change}%, rgba(58,184,255,1) ${change}%)`,
    };
  }
  return (
